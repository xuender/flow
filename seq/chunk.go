...
//
// Uses the Chunk function from the slices package to collect elements into chunks.
// Converts each chunk into a sequence and appends it to the result slice.
// Returns a slice of sequences, each of the specified size or smaller for the last chunk.
...
//
// Uses the Chunk function from the slices package to collect elements into chunks.
// Converts each chunk into a sequence of key-value pairs and appends it to the result slice.
// Returns a slice of sequences, each containing key-value pairs of the specified size or smaller for the last chunk.
